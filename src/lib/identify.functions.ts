...
{"animalName":string|null,"scientificName":string|null,"confidence":number,"description":string,"habitat":string,"interestingFacts":string[],"inSouthAfrica":boolean,"matchesKnownAnimal":string|null}
Rules:
