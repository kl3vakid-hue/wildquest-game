...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: "birder",
    name: "Birder",
    description: "Verify four of Kruger's birds.",
    icon: "🦅",
    points: 175,
    species: ["fish-eagle", "ground-hornbill", "saddle-billed-stork", "kori-bustard", "marabou", "lilac-breasted-roller", "guineafowl", "fishing-owl", "ostrich"],
    count: 4,
  },
  {
    id: "cold-blooded",
    name: "Cold Blooded",
    description: "Verify three reptiles: snakes, lizards or tortoises.",
    icon: "🦎",
    points: 175,
    species: ["crocodile", "nile-monitor", "leopard-tortoise", "chameleon", "rock-python", "black-mamba", "puff-adder"],
    count: 3,
  },
  {
    id: "curator",
